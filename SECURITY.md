...
This repository holds a retained historical/archived reference implementation of a Python client for SAS Customer Intelligence 360's Data Management and Marketing Data APIs (audience data, customer profiles, and marketing data operations). It is no longer actively developed. Only the code currently deployed on each environment branch is supported — there is no long-term support for older commits.
...
- GitHub's [private vulnerability reporting](https://github.com/mnelson3/sas-ci360-sol-data-archived/security/advisories/new) (enabled on this repo), or
